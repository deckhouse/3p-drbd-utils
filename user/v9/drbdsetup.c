...
struct drbd_cmd commands[] = {
	...
	{"track-bitmap", CTX_PEER_DEVICE, DRBD_ADM_TRACK_BITMAP, DRBD_NLA_TRACK_BITMAP_PARMS, F_CONFIG_CMD,
	 .ctx = &track_bitmap_cmd_ctx,
	 .summary = "Start or stop tracking writes in bitmap for a peer device." },
	{"flush-bitmap", CTX_MINOR, DRBD_ADM_FLUSH_BITMAP, NO_PAYLOAD, F_CONFIG_CMD,
	 .summary = "Flush in-memory bitmap to on-disk metadata." },
